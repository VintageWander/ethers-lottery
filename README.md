...
```bash
git clone https://github.com/VintageWander/ethers-lottery.git
cd ethers-lottery
npm install
npm run compile
```
...
Head over to [faucets.chain.link](https://faucets.chain.link/) and get some tesnet ETH & LINK. Or you can also go to [sepoliafaucet.com](https://sepoliafaucet.com/). <br>
You should see the ETH and LINK show up in your metamask. [You can read more on setting up your wallet with LINK.](https://docs.chain.link/docs/deploy-your-first-contract/#install-and-fund-your-metamask-wallet)
...
```
npm hardhat run scripts/enter.ts --network sepolia
```
...
```
npm hardhat verify --constructor-args arguments.ts DEPLOYED_CONTRACT_ADDRESS
```
